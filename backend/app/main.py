...
from app.routers import auth, meta, banks, transactions, unverified, imports, analytics, budgets, activity, export, categories, modes, jars
...
app.include_router(jars.router, prefix="/api/v1")
